...
import UserManagerArtifact from "../../../abi/AssetManager.json";
import AssetManagerArtifact from "../../../abi/UserManager.json";
...
const loadDAPP = (resolve, reject) => {
    return async () => {
        try {
            ...
            dapp.contracts.UserManager = TruffleContract(UserManagerArtifact);
            dapp.contracts.AssetManager = TruffleContract(AssetManagerArtifact);

            // set providers on trufflised contracts
            dapp.contracts.UserManager.setProvider(web3Provider);
            dapp.contracts.AssetManager.setProvider(web3Provider);
